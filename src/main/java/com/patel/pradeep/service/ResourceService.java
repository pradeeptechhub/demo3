package com.patel.pradeep.service;
...
public class ResourceService {
	...
	public ResourceService() {
		...
		this.resources.add(new Resource(2L, "Analyst", "Staff", new BigDecimal("50.00"), "Hours"));
		this.resources.add(new Resource(3L, "Tester", "Staff", new BigDecimal("70.00"), "Hours"));
	}
